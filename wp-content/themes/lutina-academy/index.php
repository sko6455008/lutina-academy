        ...
        <footer id="contact" class="bg-white border-t border-accent-100 pt-20 pb-10 relative overflow-hidden">
             <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        <div class="space-y-5">
                            <div class="flex items-start group">
                                ...
                                <span class="text-gray-500 font-mincho text-sm leading-relaxed">〒171-0014<br />東京都豊島区池袋2丁目53-12 中條ビル7F</span>
                            </div>
                ...
                <div class="text-center">
                    ...
                    <a href="<?php echo esc_url( lutina_academy_tokushoho_url() ); ?>" class="inline-block mt-3 py-2 text-xs font-mincho text-gray-500 underline underline-offset-4 decoration-gray-400 hover:text-accent-600 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent-600">
                        特定商取引法に基づく表記
                    </a>
                </div>
            </div>
